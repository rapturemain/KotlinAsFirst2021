...
class Test4 {
    ...
    fun `{mostExpensive} this tests checks if huge or small number is used`() {
        ...
        assertEquals("Молоко", mostExpensive("Хлеб 0.000000000000000000000000001; Молоко 0.000000000000000000000000002"))
        assertEquals("Хлеб", mostExpensive("Хлеб 0.000000000000000000000000002; Молоко 0.000000000000000000000000001"))
    }
